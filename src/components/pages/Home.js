        ...
        <Container>
          <Jumbotron className="mt-5">
            <h1 className="display-3">
              Welcome <span className="text-primary">Visiter</span>
            </h1>
            <p className="lead">
              Information about the coin market in the last 24 hours using the
              Coincap API.
            </p>
            <hr className="my-2"/>
            ...
            <p className="lead d-flex align-items-center">
              ...
              <Button color="primary" style={{marginLeft: '20px'}}>
                <a className="text-white text-decoration-none"
                   href="https://coincap.io/" target="_blank" rel="noreferrer">
                  Coincap
                </a>
              </Button>
          ...
          <Card body>
            <CardTitle tag="h5">
              Last 24 Hours Rank 1: {loading
                ? <Spinner size="sm" color="primary"/>
                : data.name}
            </CardTitle>
            <CardText>
              {loading ? <Spinner size="sm" color="primary"/> : data.name} was
              with the largest market size in the last 24 hours.
            </CardText>
