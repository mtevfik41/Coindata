            ...
            <Jumbotron fluid>
              <Container className="m-auto" fluid>
                <h1 className="display-5">{coin.name} <span
                  ...
                  <span className="display-6" style={{
                    fontSize: '18px',
                    marginLeft: '15px',
                  }}>{coin.symbol}</span>
                </h1>
                <ListGroup>
                  ...
                  <ListGroupItem>Market Cap:
                    <span className="text-primary fr">
                      {Number(coin.marketCapUsd).toFixed(2)}$
                    </span>
                  </ListGroupItem>
                  <ListGroupItem>Max Supply:
                    <span className="text-primary fr">
                  ...
                  <ListGroupItem>24 Hour Volume:
                    <span className="text-primary fr">
                      {Number(coin.volumeUsd24Hr).toFixed(2)}$
                    </span>
                  </ListGroupItem>
                  <ListGroupItem>Average Price 24 Hour:
                    <span className="text-primary fr">
